...
?>
        ...
        <link rel='stylesheet' href='/wp-content/themes/html5blank-master/css/karaoke-set_copy.css'>
           ...
           <?php
            if(ICL_LANGUAGE_CODE == 'ru'){
                $pre_lang = "/";
                $call_form_id='79';
                $image_main='/wp-content/themes/html5blank-master/images/karaoke-set/EVOBOX+mic-RU.jpg';
                ...
                $call_form_id='78';
                $image_main='/wp-content/themes/html5blank-master/images/karaoke-set/EVOBOX+mic-EN.jpg';
                ...
                $pre_lang = "/".ICL_LANGUAGE_CODE."/";
                $call_form_id='80';
                $image_main='/wp-content/themes/html5blank-master/images/karaoke-set/EVOBOX+mic-UA.jpg';
        ...
        <section class="sets base_container">
            <h1 class="base_title"><?php _e('Караоке-комплект','my'); ?> <br><?php _e('с микрофонами','my'); ?></h1>
            <div class="base_txt"><?php _e('Базовый караоке-комплект для домашнего караоке от Studio Evolution.','my'); ?><br> <?php _e('Включает в себя профессиональную караоке-систему','my'); ?><br> <?php _e('и два цифровых беспроводных микрофона','my'); ?> SE • 200D. </div>
            <div class="base_tab">
                <img src="/wp-content/themes/html5blank-master/images/karaoke-set/with-mic.jpg" class="base_img"  alt="<?php echo $image_main_alt_with_all_black;?>">
                <img src="/wp-content/themes/html5blank-master/images/karaoke-set/with-mic-mob.jpg" class="base_img-mob"  alt="<?php echo $image_main_alt_with_all_black;?>">
                <img src="/wp-content/themes/html5blank-master/images/karaoke-set/evobox-grey.png" class="base_tab-img active" id="micGrey" alt="профессиональная караоке система с микрофонами серая">
                <img src="/wp-content/themes/html5blank-master/images/karaoke-set/evobox-red.png" class="base_tab-img" id="micRed" alt="профессиональная караоке система с микрофонами красная">
                <img src="/wp-content/themes/html5blank-master/images/karaoke-set/evobox-blue.png" class="base_tab-img" id="micBlue" alt="профессиональная караоке система с микрофонами синяя">
                <img src="/wp-content/themes/html5blank-master/images/karaoke-set/evobox-gold.png" class="base_tab-img" id="micGold" alt="профессиональная караоке система с микрофонами золотая">
                <img src="/wp-content/themes/html5blank-master/images/karaoke-set/evobox-silver.png" class="base_tab-img" id="micSilver" alt="профессиональная караоке система с микрофонами серебрянная">
                <img src="/wp-content/themes/html5blank-master/images/karaoke-set/evobox-black.png" class="base_tab-img" id="micBlack" alt="профессиональная караоке система с микрофонами черная">
            </div>
            ...
            <div class="sets_inner">
                <div class="sets_col">
                    ...
                    <div class="base_txt"><?php _e('Караоке-система и 2 цифровых беспроводных микрофона','my'); ?> SE • 200D.</div>
                    <br>
        ...
        <section class="sets_include">
           <div class="base_container">
               <h2 class="sets_include-title"><?php _e('Что входит в','my'); ?> <a href="<?php echo $pre_lang;?>komplekty-dlya-karaoke/"><?php _e('караоке-комплект?','my'); ?></a></h2>
               ...
               <div class="sets_include-tab-content active" id="systemBlock">
                   <a href="<?php echo $evobox_link;?>" class="sets_include-img" target="_blank"><img src="/wp-content/themes/html5blank-master/images/karaoke-set/EvoBox-set.jpg" class="sets_include-evobox" alt="<?php echo $image_main_alt_with_all_white;?>"></a>
            ...
            <div class="base_container">
                <div class="sets_banner-inner">
                    ...
                    <div class="sets_banner-img sets_banner-grey">
                        <img src="/wp-content/themes/html5blank-master/images/karaoke-set/banner_evobox.png" class="sets_banner-evobox" alt="EVOBOX">
                    </div>
                </div>
                <div class="sets_banner-inner">
                    <div class="sets_banner-content sets_banner-yellow">
                        <img src="/wp-content/themes/html5blank-master/images/karaoke-set/evobox-plus-mob.png" class="sets_banner-evobox-mob" alt="EVOBOX">
